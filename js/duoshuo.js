(function (e, t, n) {
    ...
    var r = e.location,
        ...
        b = e.DUOSHUO = {
            ...
            libs: {
                jQuery: y + "http://static.duoshuo.com/libs/embed.compat.js?24f8ca3f.js",
                smilies: y + "http://static.duoshuo.com/libs/smilies.js?921e8eda.js",
            ...
            require: function (e, t) {
                if (typeof e == "string") b.loaded[e] ? t() : j(b.libs[e], function () {
                    b.loaded[e] = !0, t()
                });
        ...
        C = {
            ...
            b.ajax("GET", e, t, n || function () {}, r)
        }, L = function (e, t, n, r) {
            b.ajax("POST", e, t, n || function () {}, r)
        }, A = [],
        O, M = [],
        _ = function (t) {
            ...
            M.push(i.stringify(t)), O || (O = b.webSocket = new WebSocket("ws://ws.duoshuo.com:8201/"), O.onopen = function () {
                ...
                switch (r.type) {
                case "post":
                    for (; t < b.pagelets.length; t++) n = b.pagelets[t], n.threadId == r.thread_id && n.onMessage(r);
                    break;
                case "notification":
                    A.push(r), ft();
                    break;
        ...
        }, I = b.smilies = {}, q = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"],
        R = 0,
        U, z = function () {
            var e = {}, t = 0;
    ...
    var $ = b.templates = {
        ...
        serviceList: function (e) {
            var t = '<ul class="ds-service-list">',
                // modified by scinart
                // origin: n = ["weibo", "qq", "renren", "douban"],
                n = ["weibo", "renren", "douban", "google"],
                r = 0;
            for (; r < n.length; r++)
                 t += $.loginItem(n[r], e);
            return t + "</ul>"
        ...
        bindUrl: function (e) {
            return b.hostUrl + "/bind/" + e + "/" + z(U.sso && U.sso.login ? {
                sso: 1,
                redirect_uri: U.sso.login
            } : null, W())
        },
        logoutUrl: function () {
            return b.hostUrl + "/logout/" + z(U.sso && U.sso.logout ? {
                sso: 1,
    ...
    var Y = b.Event = G.extend({
        ...
        nt = b.visitor = new Z,
        rt = b.unread = new Z,
        it = b.threads = {}, st = b.postPool = {}, ot = b.users = {};
    et.on("queryDefined", function () {
        ...
        function vt(e, t) {
            ...
            this.delegate("a.ds-post-likes", "click", function (e) {
                if (lt()) return gt(), !1;
                var t = i(this).parent();
                return liked = t.hasClass("ds-post-liked"), matches = i(this).html().match(/\((\d+)\)/), likes = (matches ? parseInt(matches[1]) : 0) + (liked ? -1 : 1), L("/api/posts/vote", {
                ...
                var n = this;
                if (bubbleOutTimer && Q.owner == n) clearTimeout(bubbleOutTimer), bubbleOutTimer = 0;
                else {
                    var r = i(n);
        ...
        var i = b.jQuery,
            ...
            c = b.loadRequire = function (e) {
                e.serverTime && (l = (new Date).getTime() - e.serverTime * 1e3), e.visitor && (!nt.data && e.visitor.user_id && u && !u.checkPermission() && _({
                    logged_user_id: e.visitor.user_id
                }), nt.reset(e.visitor)), e.site && (tt.reset(e.site), ct("ds_site_" + U.short_name, e.site, e.serverTime)), !b.theme && tt.data.theme && ht(tt.data.theme), e.lang && (at(C, e.lang), ct("ds_lang_" + U.short_name, e.lang, e.serverTime));
                if (e.stylesheets)
                    for (var t = 0; t < e.stylesheets.length; t++) b.injectStylesheet(e.stylesheets[t]);
        ...
        b.resetNotify = function () {
            ...
            }[tt.data.notify_position]).delegate(".ds-notify-unread a", "click", function (e) {
            ...
            for (var a in r.repostOptions) r.repostOptions[a] && (i.push(a), o = 1), s += $.serviceIcon(a, !r.repostOptions[a]);
            ...
            render: function (e) {
                ...
                var n = this,
                    ...
                    w = n.hideSmilies = function (e) {
                        ...
                        var n = B('<h2>\u793e\u4ea4\u5e10\u53f7\u767b\u5f55</h2><div class="ds-icons-32">' +
				  //modified by scinart i.map(["weibo", "qq", "renren", "kaixin", "douban", "netease", "sohu"]
				  //failed to enable google.
				  i.map(["weibo", "renren", "douban"/*, "google"*/]
                             , function (e) {
                ...
                return c.click(function () {
                    ...
                    var e = this.checked;
                    c[e ? "removeClass" : "addClass"]("ds-service-icon-grey")[e ? "addClass" : "removeClass"]("ds-service-icon"), this.value = i.map(c, k).join(",")
                }), this
            }
        }, P.Dialog = Y.extend({
            init: function (e, t) {
                (this.el = i("#ds-wrapper"))[0] || (this.el = H(i('<div id="ds-wrapper"></div>'))), this.options = i.extend({
                    width: 600
            ...
            for (var r in t) n.push('<li><a class="ds-share-to-' + r + " ds-service-link ds-" + r + '" href="' + b.hostUrl + "/share-proxy/?" + b.param({
                service: r,
        ...
        }, P.SmiliesTooltip = function () {}, P.SmiliesTooltip.prototype = {
            render: function () {
                var e = this,
        ...
        bubbleOut = function () {
            ...
            onload: function (t) {
                ...
                r.data = t.thread, ut(st, t.parentPosts || t.relatedPosts), ut(ot, t.users), r.el.find("#ds-waiting").remove(), a.like_thread_enabled && (r.meta = new P.Meta(r), r.meta.render().el.appendTo(f)), a.hot_posts && t.hotPosts && t.hotPosts.length && (r.hotPosts = new P.HotPosts(i('<div class="ds-rounded"></div>'), {
                    max_depth: 1,
                    show_context: a.show_context
                }), r.hotPosts.thread = r, r.hotPosts.el.appendTo(f), r.hotPosts.onload({
                    response: t.hotPosts,
                    options: {}
                })), r.postListHead = new P.PostListHead(r), r.postList = new D.PostList({
                    embedThread: r,
                    params: {
                        source: "duoshuo",
                        thread_id: s,
                ...
                }), r.postList.render().reset(t.response), r.paginator = new P.Paginator({
                ...
                if (lt()) {
                    ...
                    M(p)
                } else r.toolbar = i($.toolbar()).delegate(".ds-account-control", "mouseenter", function () {
                ...
                }), a.mzadx_id && (b.require("mzadxN", function () {}), i('<div id="MZADX_' + a.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(f), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
                    l: [a.mzadx_id],
                    r: "1",
                    _srv: "MZADX",
                    _callback: function (e, t) {}
                })), b.thread = r, rt.data !== n && rt.trigger("reset"), lt() || _({
        ...
        b.initSelector = function (e, t) {
            ...
            }), n.length && k("/api/threads/counts", bt({
                threads: n.join(",")
            }), function (e) {
