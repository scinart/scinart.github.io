...
date: 2017-04-24
timestamp: "2017-10-31 21:25:11 scinart"
categories: Math
comments: true
visibility: false
cc: "by-nc-nd"
...
+ 1.1.1 定义Box, Cube, 体积Vol为各边长之积
+ 1.1.2 定义不重叠Box: 内部不重叠即可
+ 1.1.4 定义被一组Box覆盖
+ 1.1.5 $$R^d$$中的开集可以表示成可数个不重叠的Cube的并
...
+ 1.1.8 定义：外测度：$$E ⊂ R^d$$，为所有包含$$E$$的可数Cube的体积的和的下确界

  $$ \lvert E \rvert_e = inf \left\{ \sum_k{\text{vol}(Q_k)} \right\} $$

+ 1.1.13 定义：外测度是次可数可加的
