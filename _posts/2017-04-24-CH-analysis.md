...
+ 1.2.1 定义 勒贝格测度 (Lebesgue Measure)
  ...
  说人话就是，存在开集 U 包含 E 且使得 U \ E 的外测度很小。
...
+ 1.2.9 定理 紧集可测
  ...
  $$ \lvert F \rvert_e + \lvert \text{一堆小盒子} \rvert_e = \lvert F ∪ \text{一堆小盒子} \rvert < \lvert U \rvert_e < \lvert F \rvert_e + ε $$
